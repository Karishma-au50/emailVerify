...
const sendVerifyMail = async(name , email , user_id) => {
    try {
       const transporter =  nodemailer.createTransport({
            ...
            secure: false, 
            auth: {
              user: "clare.quitzon15@ethereal.email", 
              pass: "pq1Y1rwuGEWmFAFUqj",
            },
        })

        const mailOption = {
            form : "clare.quitzon15@ethereal.email",
            to : email ,
...
app.post('/Signup', async (req, res) => {
    ...
    if(userData) {
        ...
        res.send("Your registration is successfully , please verify your email")
